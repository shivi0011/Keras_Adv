...
#ie. for multispectral -- 3 .... for grayscale -- 1
...
filepath="C:/Users/Adrin/Desktop/keras_bin/Best-weights-my_model-{epoch:03d}-{loss:.4f}-{acc:.4f}.hdf5"
...
if using_grayscale_or_color_flag == "grayscale":
    test_image=cv2.cvtColor(test_image, cv2.COLOR_BGR2GRAY)     #enable for grayscale image
...
#print(y_pred)
target_names = ['class 0(airpolane)', 'class 1(notAirplane)']
...
model.save("C:/Users/Adrin/Desktop/keras_bin/modelWithOpenCV_air_gray_v1.hdf5")
loaded_model=load_model("C:/Users/Adrin/Desktop/keras_bin/modelWithOpenCV_air_gray_v1.hdf5")
...
for file in os.listdir(dir):
    ...
    if filename.endswith(".jpg"):
        test_new_image(dir_in_str+"/"+filename)
